...
Free AI Tools for Realistic Human Images
ClientOnboarding code fix
ClientOnboarding Review and Next Steps
Adonix App Development Progress Review
...
Text comparison request
Change the parent div positioning classes.

Location:
tsx
<div className="absolute right-0 top-0 h-full w-[60%] flex items-center justify-end z-0">
To move the girl image to the right:
Change	Effect
right-0	Currently flush to right edge
right-[-20px]	Move 20px to the right (off screen)
right-10	Move 40px to the left (away from edge)
right-20	Move 80px to the left
Examples:
Move image to the left (away from right edge):
tsx
<div className="absolute right-10 top-0 h-full w-[60%] flex items-center justify-end z-0">
right-10 = 40px from right edge

Move image to the right (further off screen):
tsx
<div className="absolute right-[-30px] top-0 h-full w-[60%] flex items-center justify-end z-0">
right-[-30px] = 30px past the right edge

Center the image differently:
Change justify-end to:

justify-center = center in the div

justify-start = left align in the div

Full example - move image left by 40px:
tsx
<div className="absolute right-10 top-0 h-full w-[60%] flex items-center justify-end z-0">
  <img 
...
right-10	40px
right-20	80px
right-[-20px]	-20px (custom)
i need this directly under Social Fitness elevated
A PRIVATE, CURATED FITNESS ENVIRONMENT DESIGNED FOR THOSE WHO DEMAND ELITE STANDARDS

and all it need to be bold
Here is where to change it in the code:

Location (around line 155-165):
Current code:
...
{/* DESCRIPTION LINE - NOW BOLD, DIRECTLY UNDER */}
<p className="text-xs tracking-[0.15em] text-gray-400 font-bold uppercase mt-1 max-w-md">
  A PRIVATE, CURATED FITNESS ENVIRONMENT DESIGNED FOR THOSE WHO DEMAND ELITE STANDARDS
</p>
What changed:
Change	Why
mt-4 → mt-1	Moves it directly under (less top margin)
text-gray-500 → text-gray-400	Matches color of line above
Added font-bold	Makes it bold
If you want it even closer:
Change mt-1 to mt-0.5 or mt-0

tsx
className="text-xs tracking-[0.15em] text-gray-400 font-bold uppercase mt-0.5 max-w-md"
ok, here all the code. where it says ADONIX
SOCIAL FITNESS · ELEVATED. i need to move up more to the word adonix. BUT DONT MOVE THE LOGOS OR THE IMAGE. LEAVE IT IN PLACE, I JUST NEED THE WORDS TO BE A TAD BIT CLOSE TOGETHER AND MAKE IT ABOLD.

ALSO BRING A PRIVATE, CURATED FITNESS ENVIRONMENT DESIGNED FOR THOSE WHO DEMAND ELITE STANDARDS, HITHER TO BE JUST BELOW SOCIAL FITNESS · ELEVATED. AND MAKE A PRIVATE, CURATED FITNESS ENVIRONMENT DESIGNED FOR THOSE WHO DEMAND ELITE STANDARDS BOLD.,

MAKE The new standard for social fitness. Designed for those who are as engaging in person as they are driven in the moment. ALIGN CENTER. MAKE THE FONT 5PX BIGGER AND ITALISED AND BOLD 

DO NOT MOVE THE IMAGES OR CHANGE ANY OF THE SIZES. LEAVE THEM ALONE
...
Here is your updated code with all your text changes. Images and sizes are unchanged.
      ...
      <div className="flex-1 flex flex-col relative">
        ...
        <div className="relative z-10 flex flex-col justify-center min-h-screen">
          <div className="max-w-2xl mx-auto px-8 md:px-12 lg:px-16 w-full">
            ...
            {/* SOCIAL FITNESS · ELEVATED - moved closer to ADONIX (mt-3 to mt-1) and made bold */}
            <p className="text-sm tracking-[0.2em] text-gray-400 font-bold uppercase mt-1">
              SOCIAL FITNESS · ELEVATED
            </p>
            
            {/* DESCRIPTION LINE - directly below, bold, gray-400 to match */}
            <p className="text-xs tracking-[0.15em] text-gray-400 font-bold uppercase mt-1 max-w-md">
              A PRIVATE, CURATED FITNESS ENVIRONMENT DESIGNED FOR THOSE WHO DEMAND ELITE STANDARDS
            </p>
            
            {/* QUOTE TEXT - centered, 5px bigger, italic, bold, removed max-w-md for centering */}
            <p className="text-gray-400 text-[17px] italic font-bold text-center mt-6 leading-relaxed max-w-2xl">
              The new standard for social fitness. Designed for those who are as engaging in person as they are driven in the moment.
            </p>
...
Element	Change
SOCIAL FITNESS · ELEVATED	mt-3 → mt-1 (closer to ADONIX), added font-bold
A PRIVATE, CURATED...	mt-4 → mt-1 (directly below), added font-bold, text-gray-500 → text-gray-400
Quote text	text-center (centered), text-[17px] (5px bigger), added font-bold, max-w-md → max-w-2xl (full width)
Images	✅ NOT CHANGED
Sizes	✅ NOT CHANGED
