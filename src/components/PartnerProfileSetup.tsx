...
import {
  ...
  Award, CheckCircle, X, ShieldCheck, Info, AlertCircle
} from 'lucide-react';
    ...
    <>
      <div className="min-h-screen bg-black text-white">
        ...
        <div className="max-w-4xl mx-auto px-4 py-8">
          ...
          {/* SECTION 4: SERVICES & RATES - UPDATED */}
                    ...
                    <div key={service} className={`p-4 bg-black rounded-xl border ${hourlyError || halfHourError ? 'border-red-500/50 bg-red-500/5' : 'border-white/10'}`}>
                      ...
                      <div className="space-y-3">
                        <div>
                          ...
                          {hourlyError && (
                            <p className="text-xs text-red-400 mt-1">Hourly rate must be between $50 and $500</p>
                          )}
                        </div>
                        ...
                        {isHalfHourOn && (
                          <div>
                            ...
                            {halfHourError && (
                              <p className="text-xs text-red-400 mt-1">Half-hour rate must be between $30 and ${rate?.hourly || 'hourly rate'}</p>
                            )}
                          </div>
                        )}
