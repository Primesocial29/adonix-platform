        ...
        <div className="max-w-4xl mx-auto px-4 py-3 flex justify-between items-center">
          ...
          <div className="relative">
            ...
            {showSettingsDropdown && (
              <div className="absolute right-0 mt-2 w-48 bg-gray-900 border border-white/10 rounded-xl shadow-xl z-20">
                <div className="py-2">
                  ...
                  <button onClick={() => { window.location.href = '/browse'; setShowSettingsDropdown(false); }} className="w-full text-left px-4 py-2 text-sm hover:bg-white/10">Find Partners</button>
                  <button onClick={() => { window.location.href = '/my-requests'; setShowSettingsDropdown(false); }} className="w-full text-left px-4 py-2 text-sm hover:bg-white/10">My Requests</button>
                  <button onClick={() => { setShowFavoritesModal(true); setShowSettingsDropdown(false); }} className="w-full text-left px-4 py-2 text-sm hover:bg-white/10">Favorites</button>
                  <button onClick={() => { setShowReviewsModal(true); setShowSettingsDropdown(false); }} className="w-full text-left px-4 py-2 text-sm hover:bg-white/10">My Reviews</button>
                </div>
              </div>
            )}
          </div>
