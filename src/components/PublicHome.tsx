      ...
      */
      ...
      <div style={{ 
        ...
        <img 
          ...
          alt="Adonix Logo" 
          style={{
            width: '900px !important',        // ← CHANGE THIS NUMBER TO CONTROL SIZE
            height: 'auto !important',        // ← DO NOT CHANGE - keeps logo proportional
            maxWidth: 'none !important',      // ← REMOVES ANY MAX WIDTH CONSTRAINT
