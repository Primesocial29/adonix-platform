...
<div className="relative min-h-screen flex">
  ...
  {/* Right Side - Girl Image (DIRECT PIXEL CONTROLS) */}
  <div className="relative w-2/5 flex items-center justify-center overflow-hidden">
    <img 
      ...
      className="absolute"
      style={{ 
        width: '500px',           // ← Change this number to make image BIGGER or SMALLER
        height: 'auto',           // ← Keeps aspect ratio (don't change this)
        top: '0px',               // ← Positive number moves DOWN, negative moves UP
        left: '50%',              // ← Keeps centered (don't change this)
        transform: 'translateX(-50%)',  // ← Keeps centered (don't change this)
