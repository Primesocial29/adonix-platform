...
        </div>
        
        {/* Right Side - Girl Image (MUCH BIGGER) */}
...
    className="absolute"
    style={{ 
      width: '800px',           // ← Much bigger (was 500px)
      height: 'auto',           // ← Keeps aspect ratio
      top: '0px',               // ← Change to move DOWN or UP
      left: '0px',              // ← Change to move LEFT or RIGHT            
      // transform: 'translateX(-50%)', // Removed for pixel control
